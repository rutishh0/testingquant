...
// require local mesh-server module for Rosetta services
require github.com/rutishh0/mesh-server v0.0.0
...
replace github.com/rutishh0/mesh-server => ./mesh-server
